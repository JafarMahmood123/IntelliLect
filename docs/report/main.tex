...
\begin{center}
  ...
  {\fontsize{22.4}{28}\selectfont
   نظام تعلم عن بعد مدعوم بمساعد ذكي\\[6pt]
   مبني على النماذج اللغوية\par}

  \vspace{2.5cm}
  {\fontsize{14.4}{18}\selectfont تقديم\par}
  {\bfseries\fontsize{14.4}{18}\selectfont جعفر رامي محمود\par}

  \vspace{1.5cm}
  {\fontsize{14.4}{18}\selectfont إشراف\par}
  {\bfseries\fontsize{14.4}{18}\selectfont ما. عماد قرحيلي\\[6pt]
   ما. طلال أنطاكية لي\par}
...
\input{chapters/01-general-framework}
% Chapters 2 and 3 are temporarily OUT of the build. The files stay in
% chapters/ untouched — re-enable by uncommenting these two lines.
% Three cross-references in chapter 5 pointed into chapter 2; they are marked
% with "% CH2-REF" there and must be restored at the same time.
%\input{chapters/02-theoretical-study}
%\input{chapters/03-related-work}
\input{chapters/04-requirements-analysis}
\input{chapters/05-system-design}
\input{chapters/06-implementation-and-testing}
