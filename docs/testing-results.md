...
| Suite | Tests | Command |
|---|---|---|
| UserManagementService | 275 | `dotnet test UserManagementService/tests/*/*.csproj` |
...
|---|---|---|---|---|
| UserManagementService | 50.0% | 34.9% | measured 2026-08-07 (991 lines) | `cd backend/UserManagementService && dotnet test --collect:'XPlat Code Coverage' -s ../coverlet.runsettings` |
