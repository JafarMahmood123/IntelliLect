...
/// <summary>
/// Reads and drives KnowledgeService's super-admin document view: the indexing status of files,
...
/// </summary>
public interface IKnowledgeAdminClient
{
    /// <summary>KnowledgeService-driven document page (used when a status filter is applied).</summary>
...
/// <summary>A document row from KnowledgeService (indexing side): mirrors AdminDocumentItem.</summary>
